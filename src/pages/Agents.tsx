...
export default function Agents() {
  ...
  const [selectedId, setSelectedId] =
    useState<AgentRole | null>("orchestrator");
      ...
      <section className="mx-auto max-w-7xl px-6 md:px-10 pt-16 md:pt-20 pb-10">
        ...
        <div className="flex flex-wrap items-end justify-between gap-8">
          ...
          <p className="max-w-sm text-ivory-dim text-sm leading-relaxed">
            Every claim VERITAS handles passes through this
            council. Hover or select any node below to see what
            it is responsible for, then explore the council
            visualization and understand how the different
            reasoning roles contribute to the final verdict.
          </p>
        </div>
